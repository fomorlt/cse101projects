...
int main() {
  ...
  if (A.size() != 0) {
    ...
    cout << "------------------------------" << endl;
  cout << "Testing repeated set values" << endl;
  A.setValue("abcd", 6);
  cout << "A first time: " << endl << A << endl;
  A.setValue("abcd", 9);
  cout << "A second time: " << endl << A << endl;
  int& valthing = A.getValue("abcd");
  valthing++;
  cout << "A after valthing++" << endl << A << endl;
